...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal" id="PhotoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img class="imgPreview mt-3" id="imgPreview" src="{{asset('http://localhost/images/default.png')}}">
...
@section('script')
    <script type="text/javascript">
        ...
        $('#SavePhoto').on('click',function () {
            $('#SavePhoto').html("<div class='spinner-border spinner-border-sm text-light' role='status'></div>")
        ...
        function LoadByID(FirstImgID,loadMoreBtn){
            ...
            let URL="/PhotoJSONByID/"+PhotoID
             loadMoreBtn.html("<div class='spinner-border spinner-border-sm text-light' role='status'></div>")
             axios.get(URL).then(function (response) {
